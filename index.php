                        ...
                        <div class="col-xl-7 col-lg-8 offset-xl-5 offset-lg-4">
                            <div class="office-pera">
                                <div class="section-tittle">
                                    <h2 class="mb-30">IT'S TIME TO COME AND CLEAN YOUR CAR</h2>
                                    <ul>
                                        <li>.We're professional and certified car washers</li>
                                        <li>.We use quality material to clean your cars</li>
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-10">
                        <div class="single-card text-center mb-30">
                            ...
                            <div class="card-bottom">
                                <ul>
                                    <li><span style='font-size:20px;'>&#10004;</span>Exterior wash</li>
                                    <li><span style='font-size:20px;'>&#10060;</span>Interior vaccum</li>
                                    <li><span style='font-size:20px;'>&#10060;</span>Exterior Polish</li>
                                    <li><span style='font-size:20px;'>&#10060;</span>Tire Shine</li>
                                </ul>
                                <a href="index2.php" class="btn">Select Now</a>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-10">
                        <div class="single-card text-center mb-30">
                            <div class="card-top">
                                <img src="assets/img/icon/price1.svg" alt="">
                                <h4>Full Service  With  Polishing</h4>
                                <p>Starting at</p>
                            </div>
                            <div class="card-mid">
                                <h4>800.00</h4>
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-7 col-md-10 col-sm-11">
                        <div class="section-tittle mb-60">
                            ...
                            <p>We Only Provide Quality Care Services.</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                                ...
                                <div class="single-footer-caption mb-30">
                                    ...
                                    <div class="footer-tittle">
                                        <div class="footer-pera">
                                            <p>Car Spa Services For Your Cars</p>
                                        </div>
                                        <ul class="mb-40">
                                            <li class="number"><a href="#">+91 2360 4537</a></li>
