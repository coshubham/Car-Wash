...
<body>
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row" >
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo"><img src="logo.png" alt="logo" style="height:2.7rem; width:2.7rem; border-radius:px"><p style="font-size:1.4rem;display:inline; margin-left:1rem">Admin Panel</p></a>
      </div>
