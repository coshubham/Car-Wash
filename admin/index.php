          ...
          <div class="col-lg-6 d-flex align-items-center justify-content-center">
            <div class="auth-form-transparent text-left p-3">
              <div class="brand-logo">
                <img src="1.png" alt="" style="width:80rem; margin-left:-11rem; margin-top:3rem position:fixed;"></div>
              <div class="main" style=" position: relative; left:30rem; top:-69rem; left:22rem;">
              ...
              <form class="pt-3" method="POST">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control form-control-lg border-left-0" id="exampleInputEmail" placeholder="Username"  style="font-size:1.1rem; color:#333" name="admin_name">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="password" class="form-control form-control-lg border-left-0" id="exampleInputPassword" placeholder="Password"  style="font-size:1.1rem; color:#333" name="password">                        
                  </div>
                </div>
